...
Adapt all the other answers accordingly, using "_Aloha_" instead of "_Hello_".
...
Use the `$age` and `$gender` variables in an `if/else` to display a "_welcome to the team !_" or "_Sorry you don't fit the criteria_" message.
