...
Washing the dishes... _Yuk, never liked that, never will_.

Wash my plate? _No problemo_.

```php
wash_plate();
```

But wash the 57 plates of yesterday's orgy... _Euuuuuuuuh.... Excuse me ?_
...
![selectbox](./assets/selectbox.png)
...
![woohoo anim](./assets/woohoo-anim.gif)
